...
**Objective:** Develop a classification model to predict whether a household is at risk of poverty using demographic and socioeconomic data.

**Dataset:** Living Conditions Survey (Encuesta de Condiciones de Vida - ECV) 2024 from the Spanish National Statistics Institute (INE). The ECV is the Spanish version of the EU-SILC (European Union Statistics on Income and Living Conditions) survey.

**Target Variable:** `vhPobreza` - Binary indicator of poverty risk (0=No, 1=Yes)
...
See [Machine Learning Strategy](docs/machine-learning-strategy.md) for details.

#### Target Variable
- **`vhPobreza`** - At risk of poverty indicator
- Located in household file (ECV_Th_2024)
- Binary: 0 (Not at risk) / 1 (At risk)
- Based on EU-SILC poverty criteria
...
**For detailed strategy, see [Machine Learning Strategy](docs/machine-learning-strategy.md)**
...
**For complete examples, see [Quick Start Guide](docs/quick-start.md)**
